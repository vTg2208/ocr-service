...
from app.services.cadastral_candidates import extract_cadastral_candidates


class LandCandidateTests(unittest.TestCase):
    def test_extracts_separate_survey_area_pairs(self):
        candidates = extract_cadastral_candidates(
    ...
    def test_extracts_only_explicit_valid_coordinate_pairs(self):
        ...
        self.assertEqual(extract_cadastral_candidates("Kanchipuram District").coordinates, [])
        self.assertEqual(
            extract_cadastral_candidates("Latitude: 120 Longitude: 300").coordinates,
            [],
        )
...
class DMSCoordinateTests(unittest.TestCase):
    def test_converts_explicit_dms_coordinates(self):
        candidates = extract_cadastral_candidates('12°41\'36.2"N 79°58\'32.5"E')
